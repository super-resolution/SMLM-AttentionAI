...
from models.unet import DiffusionUNet,UNet, SpatialAttentionUNet
...
class Network(NetworkBase):
    def __init__(self, cfg):
        ...
        self.unet = SpatialAttentionUNet((hidden_d,hidden_d*2,hidden_d*4), initial_conv=[1,hidden_d])
        self.unet2 = SpatialAttentionUNet((hidden_d*2,hidden_d*4,hidden_d*8), initial_conv=[hidden_d,hidden_d*2])
